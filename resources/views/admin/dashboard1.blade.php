        ...
        <div class="topbar-right">
          ...
          <div class="profile-wrap" id="profile-wrap">
            ...
            <div class="profile-menu">
              ...
              <a class="profile-menu-item" href="{{ route('admin.profile') ?? '#' }}">
                <span>👤</span> Profile
              </a>
      ...
      <div class="content">
        ...
        <div class="tab-panel active" id="tab-mandal">
          ...
          <div class="toolbar">
            ...
            <button class="btn-primary-sm" onclick="showToast('Hook this up to your Add Mandal modal/route')">
              + Add Mandal
            </button>
          </div>
        ...
        <div class="tab-panel" id="tab-village">
          ...
          <div class="toolbar">
            ...
            <button class="btn-primary-sm" onclick="showToast('Hook this up to your Add Village modal/route')">
              + Add Village
            </button>
          </div>
